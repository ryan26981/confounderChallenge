...
ax.axvspan(overlap_low, overlap_high, alpha=0.15, color="gray", zorder=0)

ax.scatter(
    patients_df.loc[dreamy, "severity"],
    patients_df.loc[dreamy, "post_surgical_score"],
    marker="o",
    s=55,
    facecolors=dreamy_color,
...
ax.set_xlabel("Initial Patient Severity", fontsize=11)
ax.set_ylabel("Post-Surgical Symptom Score (Lower is Better)", fontsize=11)
ax.set_title("Post-Surgical Symptom Score by Patient Severity", fontsize=12, pad=10)
ax.grid(True, linestyle=":", linewidth=0.8, alpha=0.65)
ax.legend(frameon=True, loc="lower right", fontsize=10)
